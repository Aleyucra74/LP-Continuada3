#!/bin/bash
echo -e "\e[48;5;204m [Sensiders]: \e[0m clonando o repo..."
#git clone https://github.com/Aleyucra74/LP-Continuada3.git
...
if [[ $? = 0 ]]
	then
		...
		sudo chmod 777 lp-continuada3-1.0-SNAPSHOT-jar-with-dependencies.jar
		java -jar lp-continuada3-1.0-SNAPSHOT-jar-with-dependencies.jar
	else
